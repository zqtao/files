...
public class MediaFile {
    ...
    public static final int FILE_TYPE_XLS     = 52;
    ...
    static {
        ...
        addFileType("DOC", FILE_TYPE_M3U, "audio/x-mpegurl");
        addFileType("DOCX", FILE_TYPE_PLS, "audio/x-scpls");
        addFileType("WPL", FILE_TYPE_WPL, "application/vnd.ms-wpl");
    ...
    //根据文件路径获取文件类型
    public static int getDetailFileType(String path) {
        MediaFileType type = getFileType(path);
        if(null != type) {
